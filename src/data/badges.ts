...
export const BADGES: BadgeDefinition[] = [
  ...
  },
  {
    ...
    namePt: "Mestre do Triângulo",
    description: "Draw a triangle",
    descriptionPt: "Desenhe um triângulo",
    icon: "🔺",
    category: "milestone",
  },
  {
    id: "circle_master",
    name: "Circle Master",
    namePt: "Mestre do Círculo",
    description: "Draw a circle using repeat",
    descriptionPt: "Desenhe um círculo usando repita",
    icon: "⭕",
    category: "milestone",
  },
  {
  ...
  },
  {
    ...
    namePt: "Mago da Recursão",
    description: "Use recursion successfully",
    descriptionPt: "Use recursão com sucesso",
    icon: "🔄",
    category: "milestone",
  },
  {
    id: "variable_guru",
    name: "Variable Guru",
    namePt: "Guru das Variáveis",
    description: "Use variables in your code",
    descriptionPt: "Use variáveis no seu código",
    icon: "📦",
    category: "milestone",
  },
  {
  ...
  // ── Completion ──
  {
    ...
    namePt: "Básico Completo",
    description: "Complete all lessons in Module 1",
    descriptionPt: "Complete todas as lições do Módulo 1",
    icon: "📗",
    category: "completion",
  },
  {
